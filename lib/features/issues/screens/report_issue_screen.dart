...
import 'package:vag_dmp_frontend/core/sync/sync_manager.dart';
...
class _ReportIssueScreenState extends ConsumerState<ReportIssueScreen> {
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      // Upload immediately when online. Offline reports remain queued and
      // notify administrators as soon as they are synced.
